module IntMake :
  functor (I : Int0.Int) (X : OrderedType.OrderedType) ->
    sig
      module X' :
        sig
          type t = X.t
        ...
        sig
          module Raw :
            sig
              ...
              type enumeration =
                MSetAVL.MakeRaw(I)(X').enumeration =
                  End
              ...
              type coq_R_min_elt =
                MSetAVL.MakeRaw(I)(X').coq_R_min_elt =
                  R_min_elt_0 of tree
                | R_min_elt_1 of tree * I.t * tree * X'.t * tree
                | R_min_elt_2 of tree * I.t * tree * X'.t * tree * I.t *
                    tree * X'.t * tree * elt option * coq_R_min_elt
              type coq_R_max_elt =
                MSetAVL.MakeRaw(I)(X').coq_R_max_elt =
                  R_max_elt_0 of tree
                | R_max_elt_1 of tree * I.t * tree * X'.t * tree
                | R_max_elt_2 of tree * I.t * tree * X'.t * tree * I.t *
              ...
              type coq_R_bal =
                MSetAVL.MakeRaw(I)(X').coq_R_bal =
                  R_bal_0 of t * X'.t * t
                | R_bal_1 of t * X'.t * t * I.t * tree * X'.t * tree
                | R_bal_2 of t * X'.t * t * I.t * tree * X'.t * tree
                | R_bal_3 of t * X'.t * t * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree
                | R_bal_4 of t * X'.t * t
                | R_bal_5 of t * X'.t * t * I.t * tree * X'.t * tree
                | R_bal_6 of t * X'.t * t * I.t * tree * X'.t * tree
                | R_bal_7 of t * X'.t * t * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree
                | R_bal_8 of t * X'.t * t
              type coq_R_remove_min =
                MSetAVL.MakeRaw(I)(X').coq_R_remove_min =
                  R_remove_min_0 of tree * elt * t
                | R_remove_min_1 of tree * elt * t * I.t * tree * X'.t *
                    tree * (t * elt) * coq_R_remove_min * t * elt
              type coq_R_merge =
                MSetAVL.MakeRaw(I)(X').coq_R_merge =
                  R_merge_0 of tree * tree
                | R_merge_1 of tree * tree * I.t * tree * X'.t * tree
                | R_merge_2 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * elt
              type coq_R_concat =
                MSetAVL.MakeRaw(I)(X').coq_R_concat =
                  R_concat_0 of tree * tree
                | R_concat_1 of tree * tree * I.t * tree * X'.t * tree
                | R_concat_2 of tree * tree * I.t * tree * X'.t * tree *
                    I.t * tree * X'.t * tree * t * elt
              type coq_R_inter =
                MSetAVL.MakeRaw(I)(X').coq_R_inter =
                  R_inter_0 of tree * tree
                | R_inter_1 of tree * tree * I.t * tree * X'.t * tree
                | R_inter_2 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * bool * t * tree *
                    coq_R_inter * tree * coq_R_inter
                | R_inter_3 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * bool * t * tree *
                    coq_R_inter * tree * coq_R_inter
              type coq_R_diff =
                MSetAVL.MakeRaw(I)(X').coq_R_diff =
                  R_diff_0 of tree * tree
                | R_diff_1 of tree * tree * I.t * tree * X'.t * tree
                | R_diff_2 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * bool * t * tree *
                    coq_R_diff * tree * coq_R_diff
                | R_diff_3 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * bool * t * tree *
                    coq_R_diff * tree * coq_R_diff
              type coq_R_union =
                MSetAVL.MakeRaw(I)(X').coq_R_union =
                  R_union_0 of tree * tree
                | R_union_1 of tree * tree * I.t * tree * X'.t * tree
                | R_union_2 of tree * tree * I.t * tree * X'.t * tree * 
                    I.t * tree * X'.t * tree * t * bool * t * tree *
      ...
      module E :
        sig
          type t = X.t
          val compare : X.t -> X.t -> X.t OrderedType.coq_Compare
          val eq_dec : X.t -> X.t -> bool
        end
    end
module Make :
            ...
            sig
              ...
              type coq_R_bal =
                MSetAVL.MakeRaw(Int0.Z_as_Int)(X').coq_R_bal =
                  R_bal_0 of t * X'.t * t
                | R_bal_1 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_bal_2 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_bal_3 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree
                | R_bal_4 of t * X'.t * t
                | R_bal_5 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_bal_6 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_bal_7 of t * X'.t * t * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree
                | R_bal_8 of t * X'.t * t
              type coq_R_remove_min =
              ...
              type coq_R_merge =
                MSetAVL.MakeRaw(Int0.Z_as_Int)(X').coq_R_merge =
                  R_merge_0 of tree * tree
                | R_merge_1 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_merge_2 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
                    t * elt
              type coq_R_concat =
              ...
              type coq_R_inter =
                MSetAVL.MakeRaw(Int0.Z_as_Int)(X').coq_R_inter =
                  R_inter_0 of tree * tree
                | R_inter_1 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_inter_2 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
                    t * bool * t * tree * coq_R_inter * tree * coq_R_inter
                | R_inter_3 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
                    t * bool * t * tree * coq_R_inter * tree * coq_R_inter
              type coq_R_diff =
                MSetAVL.MakeRaw(Int0.Z_as_Int)(X').coq_R_diff =
                  R_diff_0 of tree * tree
                | R_diff_1 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_diff_2 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
                    t * bool * t * tree * coq_R_diff * tree * coq_R_diff
                | R_diff_3 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
                    t * bool * t * tree * coq_R_diff * tree * coq_R_diff
              type coq_R_union =
                MSetAVL.MakeRaw(Int0.Z_as_Int)(X').coq_R_union =
                  R_union_0 of tree * tree
                | R_union_1 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree
                | R_union_2 of tree * tree * Int0.Z_as_Int.t * tree * 
                    X'.t * tree * Int0.Z_as_Int.t * tree * X'.t * tree * 
